let User,jwt;_10a‍.x([["register",()=>register],["login",()=>login]]);_10a‍.w("../models/user",[["default",["User"],function(v){User=v}]]);_10a‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);// the message/content that will be served when a client
...
// we are importing the user model we created in models/users.js
    ...
    try {
        await user.save()
        _10a‍.g.console.log("User created", user.name)
        return res.json({user})
        
    } catch (error) {
        _10a‍.g.console.log("Create User Failed", user)
    ...
    try {
        ...
        user.comparePassword(password, (err,match)=>{
            ...
            _10a‍.g.console.log("COMPARE PASSWORD IN LOGIN ERROR", err)
        ...
        _10a‍.g.console.log('LOGIN ERROR', err)
